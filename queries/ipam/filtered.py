...
class IPAddressesFilteredQuery(BaseQuery):
    ...
    def validate_arguments(self, arguments: Dict[str, Any]) -> bool:
        ...
        if filter_field not in self.supported_filter_fields:
            ...
            raise ValueError(f"Invalid filter field: {filter_field}. Currently supported: {available}")
    ...
    def execute(self, client, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        modified_query = query_template.replace("enter_variable_name_here", graphql_field_name)
        ...
        logger.info(f"Executing filtered IP addresses query: filter={filter_field}={filter_value}, fields={requested_fields}, addresses={address_filter}")
        ...
        try:
            ...
            if ip_addresses_data:
                ...
                return {
                    ...
                    "searched_addresses": address_filter if address_filter else "all IPs"
                }
